...
using device_grouped_conv_bwd_weight_dl_f16_instances = std::tuple<
    // clang-format off
        ...
        DeviceGroupedConvBwdWeight_Dl< NDimSpatial,  ALayout,   BLayout,   ELayout,    F16,     F16,     F16,     F32, PassThrough, PassThrough, PassThrough,                  ConvSpec,     8,     8,     8,     4,  2,      1,      2,      1,     S<4, 1>,     S<2, 1>,   S<1, 4, 1, 1, 2>,   S<1, 1, 1, 8, 1>,   S<0, 2, 3, 1, 4>,  S<0, 2, 3, 1, 4>,  S<1, 1, 1, 1, 1>,   S<0, 2, 3, 1, 4>,       S<1, 1, 1, 1, 2>,   S<1, 1, 1, 4, 2>,   S<1, 4, 1, 2, 1>,   S<0, 1, 4, 2, 3>,  S<0, 1, 4, 2, 3>,  S<1, 1, 1, 1, 1>,   S<0, 1, 4, 2, 3>,       S<1, 1, 1, 4, 2>, S<0, 1, 2, 3, 4, 5>,             5,                  1>,
        DeviceGroupedConvBwdWeight_Dl< NDimSpatial,  ALayout,   BLayout,   ELayout,    F16,     F16,     F16,     F32, PassThrough, PassThrough, PassThrough,                  ConvSpec,     8,     8,     8,     4,  2,      1,      2,      1,     S<1, 4>,     S<1, 2>,   S<1, 4, 1, 1, 2>,   S<1, 1, 1, 8, 1>,   S<0, 2, 3, 1, 4>,  S<0, 2, 3, 1, 4>,  S<1, 1, 1, 1, 1>,   S<0, 2, 3, 1, 4>,       S<1, 1, 1, 1, 2>,   S<1, 1, 1, 4, 2>,   S<1, 4, 1, 2, 1>,   S<0, 1, 4, 2, 3>,  S<0, 1, 4, 2, 3>,  S<1, 1, 1, 1, 1>,   S<0, 1, 4, 2, 3>,       S<1, 1, 1, 4, 2>, S<0, 1, 2, 3, 4, 5>,             5,                  1>,
        DeviceGroupedConvBwdWeight_Dl< NDimSpatial,  ALayout,   BLayout,   ELayout,    F16,     F16,     F16,     F32, PassThrough, PassThrough, PassThrough,                  ConvSpec,     8,     8,     8,     4,  2,      2,      1,      1,     S<2, 1>,     S<4, 1>,   S<1, 4, 1, 1, 2>,   S<1, 1, 1, 8, 1>,   S<0, 2, 3, 1, 4>,  S<0, 2, 3, 1, 4>,  S<1, 1, 1, 1, 1>,   S<0, 2, 3, 1, 4>,       S<1, 1, 1, 1, 2>,   S<1, 1, 1, 4, 2>,   S<1, 4, 1, 2, 1>,   S<0, 1, 4, 2, 3>,  S<0, 1, 4, 2, 3>,  S<1, 1, 1, 1, 1>,   S<0, 1, 4, 2, 3>,       S<1, 1, 1, 4, 2>, S<0, 1, 2, 3, 4, 5>,             5,                  1>,
        DeviceGroupedConvBwdWeight_Dl< NDimSpatial,  ALayout,   BLayout,   ELayout,    F16,     F16,     F16,     F32, PassThrough, PassThrough, PassThrough,                  ConvSpec,     8,     8,     8,     4,  2,      2,      1,      1,     S<1, 2>,     S<1, 4>,   S<1, 4, 1, 1, 2>,   S<1, 1, 1, 8, 1>,   S<0, 2, 3, 1, 4>,  S<0, 2, 3, 1, 4>,  S<1, 1, 1, 1, 1>,   S<0, 2, 3, 1, 4>,       S<1, 1, 1, 1, 2>,   S<1, 1, 1, 4, 2>,   S<1, 4, 1, 2, 1>,   S<0, 1, 4, 2, 3>,  S<0, 1, 4, 2, 3>,  S<1, 1, 1, 1, 1>,   S<0, 1, 4, 2, 3>,       S<1, 1, 1, 4, 2>, S<0, 1, 2, 3, 4, 5>,             5,                  1>,
        DeviceGroupedConvBwdWeight_Dl< NDimSpatial,  ALayout,   BLayout,   ELayout,    F16,     F16,     F16,     F32, PassThrough, PassThrough, PassThrough,                  ConvSpec,    64,    64,     8,    32,  2,      2,      1,      1,     S<8, 2>,     S<4, 1>,   S<1, 8, 1, 4, 2>,    S<1, 4, 1, 16, 1>,  S<0, 2, 3, 1, 4>,  S<0, 2, 3, 1, 4>,  S<1, 1, 1, 1, 1>,  S<0, 2, 3, 1, 4>,       S<1, 1, 1, 1, 2>,   S<1, 1, 1, 4, 2>,    S<1, 32, 1, 2, 1>,   S<0, 1, 4, 2, 3>,  S<0, 1, 4, 2, 3>,  S<1, 1, 1, 1, 1>,      S<0, 1, 4, 2, 3>,   S<1, 1,1 , 4, 2>, S<0, 1, 2, 3, 4, 5>,                5,                  1>,
        DeviceGroupedConvBwdWeight_Dl< NDimSpatial,  ALayout,   BLayout,   ELayout,    F16,     F16,     F16,     F32, PassThrough, PassThrough, PassThrough,                  ConvSpec,    64,    64,     8,    32,  2,      2,      1,      1,     S<8, 2>,     S<2, 2>,   S<1, 8, 1, 4, 2>,    S<1, 4, 1, 16, 1>,  S<0, 2, 3, 1, 4>,  S<0, 2, 3, 1, 4>,  S<1, 1, 1, 1, 1>,  S<0, 2, 3, 1, 4>,       S<1, 1, 1, 1, 2>,   S<1, 1, 1, 4, 2>,    S<1, 32, 1, 2, 1>,   S<0, 1, 4, 2, 3>,  S<0, 1, 4, 2, 3>,  S<1, 1, 1, 1, 1>,      S<0, 1, 4, 2, 3>,   S<1, 1,1 , 4, 2>, S<0, 1, 2, 3, 4, 5>,                5,                  1>,
        // MPerBlock=8, NPerBlock=8
        DeviceGroupedConvBwdWeight_Dl< NDimSpatial,  ALayout,   BLayout,   ELayout,    F16,     F16,     F16,     F32, PassThrough, PassThrough, PassThrough,                  ConvSpec,     8,     8,     8,     4,  2,          2,          1,  1, S<2, 1>,     S<4, 1>,      S<1, 4, 1, 1, 2>,   S<1, 1, 1, 8, 1>,  S<0, 1, 4, 2, 3>,  S<0, 1, 4, 2, 3>,  S<1, 1, 1, 1, 1>,  S<0,1, 4, 2, 3>,        S<1, 1, 1, 1, 2>,   S<1, 1, 1, 4, 2>,        S<1, 4, 1, 2, 1>,   S<0, 1, 4, 2, 3>,  S<0, 1, 4, 2, 3>,      S<1, 1, 1, 1, 1>,      S<0, 1, 4, 2, 3>,        S<1, 1,1,  4, 2>, S<0, 1, 2, 3, 4, 5>,                5,                  1>,
        DeviceGroupedConvBwdWeight_Dl< NDimSpatial,  ALayout,   BLayout,   ELayout,    F16,     F16,     F16,     F32, PassThrough, PassThrough, PassThrough,                  ConvSpec,     8,     8,     8,     4,  2,          2,          1,  1, S<1, 2>,     S<1, 4>,      S<1, 4, 1, 1, 2>,   S<1, 1, 1, 8, 1>,  S<0, 1, 4, 2, 3>,  S<0, 1, 4, 2, 3>,  S<1, 1, 1, 1, 1>,  S<0,1, 4, 2, 3>,        S<1, 1, 1, 1, 2>,   S<1, 1, 1, 4, 2>,        S<1, 4, 1, 2, 1>,   S<0, 1, 4, 2, 3>,  S<0, 1, 4, 2, 3>,      S<1, 1, 1, 1, 1>,      S<0, 1, 4, 2, 3>,        S<1, 1,1,  4, 2>, S<0, 1, 2, 3, 4, 5>,                5,                  1>
           // clang-format on
    >;
