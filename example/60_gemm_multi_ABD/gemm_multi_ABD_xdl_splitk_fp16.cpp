...
int main(int argc, char* argv[])
{
    ...
    auto a_element_op   = AElementOp{1.0};
    ...
    device_op.SetWorkSpaceSize(&argument, device_op.GetWorkSpaceSize(&argument));
    device_op.SetWorkSpacePointer(&argument, gemm_workspace_dev.GetDeviceBuffer(), StreamConfig{});
