...
int run(int argc, char* argv[])
{
    ...
    // y dot ygrad sum
    std::vector<ck::index_t> ors_gs_ms_lengths{G0, G1, M};
    std::vector<ck::index_t> ors_gs_ms_strides{
    ...
    Tensor<ORSDataType> ors_gs_ms(ors_gs_ms_lengths, ors_gs_ms_strides);
    ...
    std::cout << "ors_gs_ms_os: " << ors_gs_ms.mDesc << std::endl;
    ...
    DeviceMem ors_device_buf(sizeof(ORSDataType) * ors_gs_ms.mDesc.GetElementSpaceSize());
    ...
    // get z matrix
    {
        auto argument = gemm.MakeArgument(
            ...
            static_cast<ORSDataType*>(ors_device_buf.GetDeviceBuffer()),
