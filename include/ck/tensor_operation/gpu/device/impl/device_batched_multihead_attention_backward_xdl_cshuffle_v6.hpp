...
#include "ck/tensor_operation/gpu/grid/gridwise_batched_multihead_attention_backward_xdl_cshuffle_pt8.hpp"
...
#endif
        kernel_batched_multihead_attention_backward_ydotygrad(
            const InputDataType* __restrict__ p_y_grid,
            const InputDataType* __restrict__ p_ygrad_grid,
            ORSDataType* __restrict__ p_ors_grid,
...
__global__ void
    ...
    __launch_bounds__(CK_MAX_THREAD_PER_BLOCK, /*CK_MIN_BLOCK_PER_CU*/ 1)
        ...
        kernel_batched_multihead_attention_backward_xdl_cshuffle_v1(
            ...
            const ORSDataType* __restrict__ p_ors_grid,
            const InputDataType* __restrict__ p_ygrad_grid,
    ...
    : public BaseOperator // TODO inherit atten bwd op once API stablizes
{
    ...
    */
    ...
    using ORSGridDesc_M        = decltype(MakeLSEGridDescriptor_M(1));
    ...
    struct Argument : public BaseArgument
    {
        Argument(
            ...
            const std::vector<index_t>& ors_gs_ms_lengths,
            ...
            : p_a_grid_{p_a_grid},
              ...
              ors_grid_desc_m_{DeviceOp::MakeLSEGridDescriptor_M(ors_gs_ms_lengths[NumDimG])},
              k_grid_desc_n_k_{
              ...
              ors_block_2_ctile_map_{
                  GridwiseYDotYGrad::MakeDefaultBlock2CTileMap(y_grid_desc_m_o_)},
              ors_y_grid_desc_mblock_mperblock_oblock_operblock_{},
        ...
        ORSGridDesc_M ors_grid_desc_m_;
        ...
        typename GridwiseYDotYGrad::DefaultBlock2CTileMap ors_block_2_ctile_map_;
    ...
    struct Invoker : public BaseInvoker
    {
        ...
        float Run(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
            ...
            float ave_time = 0;
            {
                ...
                auto launch_kernel = [&]() {
                    const auto kernel = kernel_batched_multihead_attention_backward_ydotygrad<
                        GridwiseYDotYGrad,
                        InputDataType,
                        ORSDataType,
                    ...
                    return launch_and_time_kernel(
                        ...
                        arg.p_ygrad_grid_,
                        arg.p_ors_grid_,
                        arg.ors_y_grid_desc_mblock_mperblock_oblock_operblock_,
        ...
        std::tuple<unsigned long long, unsigned long long> seeds) // override
    {
        return std::make_unique<Argument>(static_cast<const InputDataType*>(p_a),
                                          ...
                                          static_cast<ORSDataType*>(p_ors_grid),
