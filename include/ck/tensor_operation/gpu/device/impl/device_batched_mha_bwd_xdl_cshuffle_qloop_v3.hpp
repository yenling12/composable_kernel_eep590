...
struct DeviceBatchedMultiheadAttentionBackward_Qloop_Xdl_CShuffle_V3
    : public BaseOperator // TODO inherit atten bwd op once API stablizes
{
    ...
    using DeviceOp = DeviceBatchedMultiheadAttentionBackward_Qloop_Xdl_CShuffle_V3;
    ...
    */
    ...
    // GridwiseGemm
    using GridwiseGemm = GridwiseBatchedMultiheadAttentionBackward_Qloop_Xdl_CShuffle_V3<
    ...
    struct Argument : public BaseArgument
    {
        Argument(const InputDataType* p_a_grid,
            ...
            : p_a_grid_{p_a_grid},
              ...
              b1grad_grid_desc_bk0_n_bk1_{DeviceOp::MakeB1GridDescriptor_BK0_N_BK1(
    ...
    std::string GetTypeString() const override
    {
        ...
        // clang-format off
        str << "DeviceBatchedMultiheadAttentionBackward_Qloop_Xdl_CShuffle_V3"
            << "<"
            << BlockSize << ", "
            << MPerBlock << ", "
            << NPerBlock << ", "
