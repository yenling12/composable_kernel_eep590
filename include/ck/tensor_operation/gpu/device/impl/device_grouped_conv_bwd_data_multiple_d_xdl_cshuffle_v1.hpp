                                               ...
                                               BComputeType>
{
    ...
    using GridwiseGemm = std::conditional_t<isMultiD, GridwiseGemmMultipleD_xdl_cshuffle<GridwiseGemmMultiDTemplateParams>, GridwiseGemm_xdl_cshuffle_v3<GridwiseGemmTemplateParams>>;
    ...
    static auto MakeEGridDescriptor_MBlock_MPerBlock_NBlock_NPerBlock(const EGridDesc_M_N e_grid_desc_m_n)
    {
        if constexpr(isMultiD) {
            ...
            return GridwiseGemm::MakeCGridDescriptor_MBlock_MPerBlock_NBlock_NPerBlock(e_grid_desc_m_n, GridwiseGemm::CalculateMBlock(M), GridwiseGemm::CalculateNBlock(N));
        }
    }
    ...
    using DsGridDesc_MBlock_MPerBlock_NBlock_NPerBlock = decltype(GridwiseGemmMultipleD_xdl_cshuffle<GridwiseGemmMultiDTemplateParams>::MakeDsGridDescriptor_MBlock_MPerBlock_NBlock_NPerBlock(DsGridDesc_M_N{}));
    using EGridDesc_MBlock_MPerBlock_NBlock_NPerBlock =
        decltype(MakeEGridDescriptor_MBlock_MPerBlock_NBlock_NPerBlock(
            EGridDesc_M_N{}));

    // block-to-e-tile map
    using Block2ETileMap =
        remove_cvref_t<decltype(GridwiseGemmMultipleD_xdl_cshuffle<GridwiseGemmMultiDTemplateParams>::MakeDefaultBlock2ETileMap(EGridDesc_M_N{}))>;
    ...
    struct Argument : public BaseArgument
    {
        ...
        typename GridwiseGemmMultipleD_xdl_cshuffle<GridwiseGemmMultiDTemplateParams>::DsGridPointer p_ds_grid_;
        EDataType* p_e_grid_;
    ...
    struct Invoker : public BaseInvoker
    {
        ...
        float RunGemm(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
            ...
            for(std::size_t i = 0; i < arg.a_grid_desc_ak0_m_ak1_container_.size(); i++)
            {
                ...
                index_t gdx, gdy, gdz;
                std::tie(gdx, gdy, gdz) = GridwiseGemm::CalculateGridSize(GemmM, GemmN, I1 /*arg.KBatch*/);

                index_t K_split = (GemmK + KPerBlock - 1) / KPerBlock * KPerBlock;
                const bool has_main_k_block_loop = GridwiseGemm::CalculateHasMainKBlockLoop(K_split);

                typename GridwiseGemm::Argument gemm_arg{arg.p_a_grid_, arg.p_b_grid_, arg.p_e_grid_, GemmM, GemmN, GemmK, I0, I0, I0, I1};
                ...
                if(has_main_k_block_loop)
                {
                    ...
                    {
                            const auto kernel =
                                kernel_grouped_conv_bwd_data_xdl_cshuffle_v3<GridwiseGemm, DeviceOp::AGridDesc_AK0_M_AK1,
                        DeviceOp::BGridDesc_BK0_N_BK1,
                        DeviceOp::EGridDesc_MBlock_MPerBlock_NBlock_NPerBlock, ComputePtrOffsetOfStridedBatch<I1, I1, I0>,
                                                            true,
                                                            InMemoryDataOperationEnum::Set,
                                                            minimum_occupancy>;
                            Run(kernel);
                    ...
                    else if constexpr(BlkGemmPipelineVer == BlockGemmPipelineVersion::v4)
                    {
                            ...
                            {
                                const auto kernel =
                                    kernel_grouped_conv_bwd_data_xdl_cshuffle_v3_2lds<GridwiseGemm,                         DeviceOp::AGridDesc_AK0_M_AK1,
                        DeviceOp::BGridDesc_BK0_N_BK1,
                        DeviceOp::EGridDesc_MBlock_MPerBlock_NBlock_NPerBlock, ComputePtrOffsetOfStridedBatch<I1, I1, I0>,
                                                                    true,
                                                                    InMemoryDataOperationEnum::Set,
        ...
        float Run(const Argument& arg, const StreamConfig& stream_config = StreamConfig{})
        {
            ...
            if constexpr(isMultiD) {
                ...
                return RunGemm(arg, stream_config);
            }
        }
