...
struct GridwiseBatchedMultiheadAttentionBackward_Qloop_Xdl_CShuffle_V2
{
    ...
    struct Gemm0
    {
        ...
        static constexpr auto b_k0 = b_src_thread_desc_k0_k1_k2_n0_n1_n2_n3_k3.GetLength(I0);
        static constexpr auto b_k1 = b_src_thread_desc_k0_k1_k2_n0_n1_n2_n3_k3.GetLength(I1);
        static constexpr auto b_k2 = b_src_thread_desc_k0_k1_k2_n0_n1_n2_n3_k3.GetLength(I2); // 1
        static constexpr auto b_n1 = b_src_thread_desc_k0_k1_k2_n0_n1_n2_n3_k3.GetLength(I4);
        static constexpr auto b_k3 = b_src_thread_desc_k0_k1_k2_n0_n1_n2_n3_k3.GetLength(I7);
        ...
        static constexpr auto b_block_slice_copy_step = make_multi_index(0, 0, 0, b_k1* b_k2* b_k3);
        static constexpr auto b_block_reset_copy_step =
            make_multi_index(0, 0, 0, -b_k0* b_k1* b_k2* b_k3);
    };
                               ...
                               const index_t block_idx_n)
    {
        ...
        auto gemm_tile_v_blockwise_copy =
            typename GemmBlockwiseCopy::template VBlockwiseCopy<decltype(
                v_grid_desc_k0_k1_k2_n0_n1_n2_n3_k3)>(v_grid_desc_k0_k1_k2_n0_n1_n2_n3_k3,
                                                      make_multi_index(0,
                                                                       0,
                                                                       wave_m_n_id[I0],
                                                                       block_work_idx_n,
        ...
        do
        {
            ...
            // assume size K == size O so HasMainKBlockLoop is the same
            {
                ...
                if constexpr(HasMainKBlockLoop)
                {
                    ...
                    do
                    {
                        ...
                        pgrad_blockwise_gemm.Run(gemm0_a_block_buf, v_thread_buf, pgrad_thread_buf);

                        pgrad_blockwise_gemm.MoveBBlockSrcSliceWindow(
                        ...
                        pgrad_gemm_tile_ygrad_blockwise_copy.RunWrite(Gemm0::a_block_desc_ak0_m_ak1,
                                                                      gemm0_a_block_buf);
                        ++i;
                    } while(i < (num_o_block_main_loop - 1));
                }
                // tail
                {
                    block_sync_lds();
                    ...
                    pgrad_blockwise_gemm.MoveBBlockSrcSliceWindow(Gemm0::b_block_slice_copy_step);
                }
            } // end gemm dP
            ...
            pgrad_blockwise_gemm.MoveBBlockSrcSliceWindow(Gemm0::b_block_reset_copy_step, true);
