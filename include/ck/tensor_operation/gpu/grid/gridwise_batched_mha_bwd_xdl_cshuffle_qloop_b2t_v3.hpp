...
struct GridwiseBatchedMultiheadAttentionBackward_Qloop_Xdl_CShuffle_V3
{
    ...
    Run(const InputDataType* __restrict__ p_q_grid,
        ...
        const VGridDesc_N0_O_N1& v_grid_desc_n0_o_n1,
        const VGridDesc_N0_O_N1& vgrad_grid_desc_n0_o_n1,
        ...
        const index_t block_idx_n)
    {
        ...
        auto vgrad_grid_buf = make_dynamic_buffer<AddressSpaceEnum::Global>(
            p_vgrad_grid, vgrad_grid_desc_n0_o_n1.GetElementSpaceSize());
        ...
        auto vgrad_grid_desc_nblock_nperblock_oblock_operblock =
            MakeVGradGridDesc_NBlock_NPerBlock_OBlock_OPerBlock(vgrad_grid_desc_n0_o_n1);
