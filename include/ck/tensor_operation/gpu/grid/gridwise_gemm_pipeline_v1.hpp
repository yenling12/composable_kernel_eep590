...
template <>
struct GridwiseGemmPipelineInterwave_v1<1, false, false>
{
    static constexpr auto I0 = Number<0>{};
    static constexpr auto I1 = Number<1>{};
...
template <>
struct GridwiseGemmPipelineInterwave_v1<1, true, true>
{
    __host__ __device__ static constexpr bool IsSupported(index_t /* num_loop */) { return true; }
...
constexpr auto GridwiseGemmPipeline_v1_Selector()
{
    ...
    {
        return GridwiseGemmPipelineInterwave_v1<NumPrefetch, AEnableLds, BEnableLds>{};
    }
}
