...
struct GridwiseBatchedMultiheadAttentionBackward_Xdl_CShuffle_V2
{
                               ...
                               const index_t block_idx_n)
    {
        ...
        do
        {
            ...
            ignore = vgrad_grid_buf;
            ignore = kgrad_grid_buf;
            ignore = pgrad_thread_buf;
            ignore = gemm1_a_thread_buf;
            ignore = gemm1_b_block_buf;
            ignore = qgrad_gemm_tile_sgrad_blockwise_copy;
            ignore = num_o_block_main_loop;
            ignore = num_gemm1_k_block_inner_loop;
            ignore = v_grid_buf;
            ignore = gemm2_a_block_buf;
