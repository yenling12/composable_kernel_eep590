...
struct ThreadwiseTensorSliceTransfer_v3r1
{
                            ...
                            Number<ThreadScratchId> thread_scratch_id = Number<ThreadScratchId>{})
    {
        ...
        static_ford<decltype(ordered_src_access_lengths)>{}([&](auto ordered_src_access_idx) {
            ...
            //  get_thread_global_1d_id(), src_coord_.GetIndex().At(Number<0>{}),
            //  src_coord_.GetIndex().At(Number<1>{}),src_coord_.GetIndex().At(Number<2>{}));
                             ...
                             Number<ThreadScratchId> thread_scratch_id = Number<ThreadScratchId>{})
    {
        ...
        static_ford<decltype(ordered_dst_access_lengths)>{}([&](auto ordered_dst_access_idx) {
            ...
            // printf("Tid: %03d, BlkDesc: (%02d, %03d, %02d), LDS offset: %05lu, LDS bank: %02lu\n",
            //        get_thread_global_1d_id(),
            //        dst_coord_.GetIndex().At(Number<0>{}),
            //        dst_coord_.GetIndex().At(Number<1>{}),
            //        dst_coord_.GetIndex().At(Number<2>{}),
            //        dst_coord_.GetOffset() * sizeof(DstData),
            //        (dst_coord_.GetOffset() * sizeof(DstData) / 4) % 32);
